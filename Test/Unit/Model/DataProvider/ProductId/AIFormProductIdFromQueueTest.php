...
namespace Creatuity\AIContentMassAction\Test\Unit\Model\DataProvider\ProductId;
...
class AIFormProductIdFromQueueTest extends TestCase
{
    private AIFormContentTypeFromQueue $contentTypeProvider;
    private MockObject $request;
    private MockObject $getNextAiContentEntry;
